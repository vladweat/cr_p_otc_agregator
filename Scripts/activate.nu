...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Python\Telegram_Bots\aggregator_bot\otc_agregator'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Python\Telegram_Bots\aggregator_bot\otc_agregator\Scripts\deactivate.nu'
